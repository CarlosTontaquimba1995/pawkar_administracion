            ...
            <Box display="grid" gap={2} mb={2}>
              ...
              >
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    handlePlayerChange("apellido", e.target.value)
                  }
                  required
                  margin="normal"
                  size="small"
              ...
              >
                <TextField
                  ...
                  onChange={(e) =>
                    handlePlayerChange("documentoIdentidad", e.target.value)
                  }
                  required
                  margin="normal"
                  size="small"
              ...
              <TextField
                ...
                onChange={(e) =>
                  handlePlayerChange("fechaNacimiento", e.target.value)
                }
                required
                margin="normal"
                size="small"
