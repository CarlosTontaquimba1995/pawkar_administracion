...
const ThemeConfigDialog = ({ open, onClose }: ThemeConfigDialogProps) => {
  ...
  const handleColorChange = (id: string, color: string) => {
    // Handle nested properties (e.g., 'text.primary')
    if (id.includes(".")) {
      const [parent, child] = id.split(".");
      updateColors({
        [parent]: {
          ...((colors[parent as keyof typeof colors] as object) || {}),
          [child]: color,
        },
      });
    } else {
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <CardContent
                        sx={{ pt: 0, px: 2.5, pb: "16px !important" }}
                      >
                        <Box
                          sx={{
                            display: "flex",
                                  ...
                                  >
                                    ...
                                    <Box
                                      sx={{
                                        ...
                                        justifyContent: "center",
                                        transition: "all 0.2s ease-in-out",
                                        pointerEvents: "none", // Prevent this from blocking the input
                                      }}
                                    >
                                      <Box
                                        sx={{
                      ...
                      >
                        ...
                        >
                          <Box>
                            ...
                            >
                              Este es un texto de ejemplo para mostrar el color
                              de texto principal.
                            </Typography>
                            <Typography
                              variant="body2"
                          ...
                          >
                            ...
                            >
                              Los cambios se aplicarán en tiempo real a medida
                              que ajustas los colores.
                            </Typography>
                          </Paper>
